...
### 🌟 Key Projects
- **[Tarpaulin - Course Management API](https://github.com/manogna7/tarpaulin-api)**  
  A containerized application for managing courses, assignments, and submissions with user authentication, AWS S3 uploads, and task handling using RabbitMQ.
  
- **Conversational AI Prototype**  
  Developed a conversational AI leveraging GPT-4 for streamlining web development tasks. Enhanced user interactions with multimodal capabilities and personalized designs.

- **Digital Vault for Will Data**  
  Built a secure digital vault to manage WILL-related data with a JSON-to-PDF module. Achieved a 40% reduction in data retrieval time.
